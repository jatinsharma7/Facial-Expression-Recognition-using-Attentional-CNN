...
class Plain_Dataset(Dataset):
    """
    Plain Dataset class helps to load the data in form of pytorch datasets and apply transformations.
    """
    ...
    def __getitem__(self, idx):
        """
        Helper function to read images one by one and apply transformations.
        """
...
def eval_data_dataloader(csv_file, img_dir, datatype, sample_number, transform=None):
    """
    Helper function to load the data and apply transformations for evaluation set.
    """
